...
import type { CusResponse } from "@humblebrag/shared/lib/injection/inject";
import {
  Table,
  TableBody,
  TableCell,
                ...
                <div className="flex-1 p-4 bg-[#f2f2f2] dark:bg-[#1c1c1e] text-[#333] dark:text-[#f2f2f2] font-mono gap-6 h-[91vh] overflow-y-auto">
                    ...
                    return (
                      ...
                      >
                        <div className="overflow-x-auto">
                          ...
                          <span className="text-[#007aff] dark:text-[#5ac8fa]">
                            ~
                          </span>
                          <span>$</span>
                              ...
                              <TableHeader className="!w-[50vw]">
                                <TableRow className="!w-[50vw]">
                                  {Object.keys(
                                    (
                                      command.response
                                        .data as unknown as Array<Object>
                                    )[0]
                                  ).map((key) => (
                  ...
                  <div className="flex w-full items-center space-x-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="getCookies()">
                          Get Cookies
                        </SelectItem>
                        <SelectItem value="getBrowser()">
                          Get Browser
                        </SelectItem>
